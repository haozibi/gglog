...
// Debug logs to the ERROR, WARNING, INFO and DEBUG logs.
...
// Debugln logs to the ERROR, WARNING, INFO and DEBUG logs.
// Arguments are handled in the manner of fmt.Println; a newline is appended if missing.
func Debugln(args ...interface{}) {
	logging.println(debugLog, args...)
}

// Debugf logs to the ERROR, WARNING, INFO and DEBUG logs.
